...
Please note that Turbolinks is no longer under active development. It has been superseeded by a new framework called [Turbo](https://github.com/hotwired/turbo), which is part of the [Hotwire](https://hotwire.dev) umbrella.
